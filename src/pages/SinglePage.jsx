                ...
                <div className="grid md:grid-cols-2">
                    ...
                    <div className="p-6 flex flex-col justify-between">
                        ...
                        <div className="flex gap-4 mt-4">
                            <Link to={`/edit/${id}`} className="flex-1 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-200">
                                Edit
                            </Link>
